...
const images = new Set(["docs/hero-banner.png", "docs/social-preview.jpg", "docs/screenshot-demo.jpg", "docs/courseraptor-logo.png", "docs/screenshot-web.png", "docs/screenshot-tui.png"]);
