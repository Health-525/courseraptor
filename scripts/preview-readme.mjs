...
const markdown = new Set(["README.md", "README.en.md", "CONTRIBUTING.md", "SECURITY.md", "CODE_OF_CONDUCT.md",
  "docs/student-guide.md", "docs/configuration.md", "docs/features.md", "docs/roadmap.md",
  "docs/promotion.md", "docs/writing-an-adapter.md", "docs/maintainers.md", "docs/github-best-practices.md"]);
const images = new Set(["docs/hero-banner.png", "docs/social-preview.jpg", "docs/screenshot-demo.jpg", "docs/demo.gif", "docs/courseraptor-logo.png"]);
...
http.createServer((req, res) => {
  ...
  try {
    if (url === "/social") {
      ...
      const contentType = name.endsWith(".jpg") ? "image/jpeg" : name.endsWith(".gif") ? "image/gif" : "image/png";
